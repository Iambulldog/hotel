	...
	<div class="main-content">
		<div class="main-content-inner">
			...
			<div class="page-content">
				...
				<div class="row">
					<?php $font = ( "SELECT * FROM fontweb where type='pattaya_restaurents1' " );
					...
					<form action="save_fontweb.php"  method="post">	
						<div class="col-xs-12">
							<div class="col-sm-12">
								<h4 class="header black">ข้อความเกี่ยวกับ pattaya restaurents ภาษาไทย</h4>
								<textarea name="detail_th" id="detail" rows="10"  cols="90%"><?php echo $ro['detail_th'];?></textarea>
								<input value="pattaya_restaurents1" name="type" hidden=""><br><br>
							</div>
						</div>

						<div class="col-xs-12">
							<div class="col-sm-12">
								<h4 class="header black">ข้อความเกี่ยวกับ pattaya restaurents ภาษาอังกฤษ</h4>
								<textarea name="detail_en" id="detail1" rows="10"  cols="90%"><?php echo $ro['detail_en'];?></textarea>
								<!-- <input value="pattaya_restaurents2" name="type" hidden=""><br><br> -->
							</div>
						</div>

						<div class="col-xs-12">
							<div class="col-sm-12">
								<h4 class="header black">ข้อความเกี่ยวกับ pattaya restaurents ภาษาจีน</h4>
								<textarea name="detail_cn" id="detail2" rows="10"  cols="90%"><?php echo $ro['detail_cn'];?></textarea>
								<!-- <input value="pattaya_restaurents2" name="type" hidden=""><br><br> --><br>
								<center>
						...
						<!-- <div class="col-xs-6">
						<?php $font = ( "SELECT * FROM fontweb where type='img_pattaya_restaurents' " );
						$re = mysqli_query( $con, $font );
						$ro = mysqli_fetch_assoc($re);
						?>
						...
						<div class="col-sm-3"></div>					
							<div class="col-sm-5" align="center">
								<h4 class="header black">จัดการรูปภาพ pattaya restaurents 1</h4>
								...
								<input value="img_pattaya_restaurents1" name="type" hidden=""><br><br>
