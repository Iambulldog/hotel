...
if(isset($_GET["delete"])) {
  ...
  //$con->query($sql);
	...
	echo "<script> alert('ได้ลบรูปภาพเรียบร้อยเเล้วค่ะ!!');window.location.href='manage_gallery.php';</script>";
		...
		<div class="main-content-inner">
			<div class="breadcrumbs ace-save-state" id="breadcrumbs">
				<ul class="breadcrumb">
					...
					<li class="active">จัดการรูปห้อง</li>
				</ul><!-- /.breadcrumb -->
			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xs-12"><br>
						...
						<!-- ข้อมูล-->
						<!-- modal add-->
						<a href="#modal-form" class="btn btn-primary" role="button" data-toggle="modal" >เพิ่มรูปห้อง</a> <br><br>
						<div id="modal-form" class="modal" tabindex="-1">
							<div class="modal-dialog modal-lg">
								<div class="modal-content">
									<div class="modal-header">
										<button type="button" class="close" data-dismiss="modal">&times;</button>
										<h4 class="blue bigger">เพิ่มรูปห้อง</h4>
									</div>
										...
										<div class="row">
											<div class="col-md-12">
												<form action="file_upload.php" enctype="multipart/form-data" method="post">
													...
													?>
													<div class="col-md-6">
														<label for="form-field-select-3"><strong>เลือกห้องพัก/สิ่งอำนวยความสะดวกที่ต้องการเพิ่ม</strong></label>
														<br />
														<select name="room" class="chosen-select form-control" id="select_room" data-placeholder="Choose a State..." >
															<option value="">เลือกห้อง</option>
															<option value="999">ร้านอาหาร</option>
															<option value="888">รอบๆโรงเเรม</option>
															<option value="887">สระว่ายน้ำ</option>
...
<hr><h3 align="center">ส่วนของสิ่งอำนวยความสะดวก</h3><hr>


				<?php $sql = ( "SELECT DISTINCT ID_room FROM img_room where ID_room > 777 " );
						$res = mysqli_query( $con, $sql );
										...
										<ul class="ace-thumbnails clearfix">
											...
											while($r2 = mysqli_fetch_assoc($res2)){?>
												<li>
													...
													<center><a href="manage_gallery.php?delete=delete&ID_imgroom=<?php echo$r2['ID_imgroom']?>&link=<?php echo$r2['link']?>" class="btn btn-danger" role="button">ลบ</a>
													</a>
													<?php if($r2['status']==1){?>
...
<hr><h3 align="center">ส่วนของห้องพัก</h3><hr>
