	...
	<div class="main-content">
		<div class="main-content-inner">
			...
			<div class="page-content">
				<?php $font = ( "SELECT * FROM fontweb where type='steak_house1' " );
				...
				<div class="row">
					<form action="save_fontweb.php"  method="post">	
						<div class="col-xs-12">
							<div class="col-sm-12">
								<h4 class="header black">ข้อความเกี่ยวกับ steak house ภาษาไทย</h4>
						...
						<div class="col-xs-12">
							<div class="col-sm-12">
								<h4 class="header black">ข้อความเกี่ยวกับ steak house ภาษาอังกฤษ</h4>
						...
						<div class="col-xs-12">
							<div class="col-sm-12">
								<h4 class="header black">ข้อความเกี่ยวกับ steak house ภาษาจีน</h4>
								<textarea name="detail_cn" id="detail2" rows="10"  cols="90%"><?php echo $ro['detail_cn'];?></textarea>
								<input value="steak_house1" name="type" hidden=""><br><br>
							</div>
							<center>
					...
					<!-- 	<div class="col-xs-6">
						<?php $font = ( "SELECT * FROM fontweb where type='img_steak_house' " );
						$re = mysqli_query( $con, $font );
						$ro = mysqli_fetch_assoc($re);
						?>
						...
						<div class="col-sm-3"></div>					
							<div class="col-sm-5" align="center">
								<h4 class="header black">จัดการรูปภาพ steak house 1</h4>
								...
								<input value="img_steak_house1" name="type" hidden=""><br><br>
