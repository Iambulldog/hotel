		...
		<div class="main-content-inner">
			<div class="breadcrumbs ace-save-state" id="breadcrumbs">
				<ul class="breadcrumb">
					...
					<li class="active">แก้ไขข้อความหน้าเว็บ Lifestyle</li>
				</ul><!-- /.breadcrumb -->
			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xs-12">
						<!-- PAGE CONTENT BEGINS -->
						<!-- ข้อมูล-->
						<?php $font = ( "SELECT * FROM fontweb where type='sl' " );
						$re = mysqli_query( $con, $font);
						$ro = mysqli_fetch_assoc($re);
						?>
						<form action="save_fontweb.php"  method="post">						
							<div class="col-sm-12">
								<h4 class="header black">ข้อความLifestyle (ภาษาไทย)</h4>
								<textarea name="detail_th" id="detail" rows="10"  cols="90%"><?php echo $ro['detail_th'];?></textarea>
								<input value="sl" name="type" hidden=""><br><br>
							</div>
							<div class="col-sm-12">
								<h4 class="header black">ข้อความLifestyle (ภาษาอังกฤษ)</h4>
								<textarea name="detail_en" id="detail1" rows="10"  cols="90%"><?php echo $ro['detail_en'];?></textarea>
							</div>
							<div class="col-sm-12">
								<h4 class="header black">ข้อความLifestyle (ภาษาจีน)</h4>
