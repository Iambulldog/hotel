	...
	<div class="main-content">
		<div class="main-content-inner">
			...
			<div class="page-content">
				<?php $font = ( "SELECT * FROM fontweb where type='shine_bar1' " );
				...
				<div class="row">
					<form action="save_fontweb.php"  method="post">	
						<div class="col-xs-12">					
							<div class="col-sm-12">
								<h4 class="header black">ข้อความเกี่ยวกับ shine bar ภาษาไทย</h4>
								<textarea name="detail_th" id="detail" rows="10"  cols="90%"><?php echo $ro['detail_th'];?></textarea>
								<input value="shine_bar1" name="type" hidden=""><br><br>
							</div>
						</div>

						<div class="col-xs-12">
							<div class="col-sm-12">
								<h4 class="header black">ข้อความเกี่ยวกับ shine bar  ภาษาอังกฤษ</h4>
						...
						<div class="col-xs-12">
							<div class="col-sm-12">
								<h4 class="header black">ข้อความเกี่ยวกับ shine bar ภาษาจีน</h4>
