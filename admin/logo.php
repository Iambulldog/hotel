		...
		<div class="main-content-inner">
			<div class="breadcrumbs ace-save-state" id="breadcrumbs">
				<ul class="breadcrumb">
					...
					<li class="active">จัดการ LOGO</li>
				</ul><!-- /.breadcrumb -->
			</div>
			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xs-12">
						<!-- PAGE CONTENT BEGINS -->
						<!-- ข้อมูล-->
						<?php $font = ( "SELECT * FROM fontweb where type='logo' " );
						...
						<div class="col-sm-3"></div>					
							<div class="col-sm-5" align="center">
								<h4 class="header black">จัดการ LOGO</h4>

								<img src="../img/<?php echo $ro['detail_th'];?>" width="300" height="150">
								<hr>
								<input type="file" name="detail_th" id="detail" class="form-control" value="" >
								<input value="logo" name="type" hidden=""><br><br>
