...
if(isset($_GET["delete"])) {
  ...
  //$con->query($sql);
	...
	echo "<script> alert('ได้ลบรูปภาพเรียบร้อยเเล้วค่ะ!!');window.location.href='dining.php';</script>";
		...
		<div class="main-content-inner">
			<div class="breadcrumbs ace-save-state" id="breadcrumbs">
				<ul class="breadcrumb">
					...
					<li class="active">จัดการ Dining</li>
				</ul><!-- /.breadcrumb -->
			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xs-12"><br>
						...
						<!-- ข้อมูล-->
						<!-- modal add-->
						<a href="#modal-form" class="btn btn-primary" role="button" data-toggle="modal" >เพิ่มรูป  Dining</a> <br><br>
						<div id="modal-form" class="modal" tabindex="-1">
							<div class="modal-dialog modal-lg">
								<div class="modal-content">
									<div class="modal-header">
										<button type="button" class="close" data-dismiss="modal">&times;</button>
										<h4 class="blue bigger">เพิ่ม Dining</h4>
									</div>
												...
												<form action="file_upload.php" enctype="multipart/form-data" method="post">
													...
													<div class="col-md-6">
														...
														<select name="room" class="chosen-select form-control" id="select_room" data-placeholder="Choose a State..." >
															...
															<option value="1000">art beach club</option>
															<option value="1001">pattaya restaurents</option>
															<option value="1002">steak house</option>
															<option value="1003">sukoi teppanyaki</option>
															<option value="1004">sky bar</option>
															<option value="1005">lagoon bar</option>
															<option value="1006">shine bar</option>
...
<hr><h3 align="center">ส่วนของรูปภาพ Dining</h3><hr>


				<?php $sql = ( "SELECT DISTINCT ID_room FROM img_room where ID_room >= 1000 AND ID_room <= 1100" );
								...
								<div class="widget-box widget-color-blue2">
									<div class="widget-header">
										<h4 class="widget-title lighter smaller">
											...
											if ($r['ID_room'] == 1000) {
											 	echo "art beach club";
											 }else if ($r['ID_room'] == 1001){
											 	echo "pattaya restaurents";
											 }else if ($r['ID_room'] == 1002){
											 	echo "steak house";
											 }else if ($r['ID_room'] == 1003){
											 	echo "sukoi teppanyaki";
											 }else if ($r['ID_room'] == 1004){
											 	echo "sky bar";
											 }else if ($r['ID_room'] == 1005){
											 	echo "lagoon bar";
											 }else{
											 	echo "shine bar";
											 } 
