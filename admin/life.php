			...
			<td>
				<ul class="ace-thumbnails clearfix ">
					<div class="center"><li>
						...
						<img width="125" height="125" src="../img/pro/<?php echo $results["img_package"]?>" />
						</a>
					</li></div>
				</ul>
			</td>
			<td><?php if ($results["sta_package"] == "0") { ?>
				<a href="life.php?delete=edit&id_package=<?php echo$results['id_package']?>&sta=1" class="btn btn-success" role="button">เปิดการใช้งาน</a>
			<?php }else{ ?>
				<a href="life.php?delete=edit&id_package=<?php echo$results['id_package']?>&sta=0" class="btn btn-danger" role="button">ปิกการใช้งาน</a>
			<?php } ?>
				
				
				<?php echo $results["detail_room_th"]?></td>
			<td><a href="edit_life.php?id_package=<?php echo $results["id_package"]?>"" class="btn btn-md btn-warning" role="button"><i class="ace-icon fa fa-pencil-square-o "></i>Edit</a></a></td>

			<td><a href="life.php?delete=delete&id_package=<?php echo$results['id_package']?>" class="btn btn-md btn-danger no-radius"  onclick="return confirm('คุณแน่ใจว่าต้องการลบข้อมูลนี้ !');"><i class="ace-icon fa fa-trash-o"></i>Delete</a></td>
		</tr>
	<?php } ?>
