		...
		<div class="main-content-inner">
			<div class="breadcrumbs ace-save-state" id="breadcrumbs">
				<ul class="breadcrumb">
					...
					<li class="active">แก้ไขข้อความเกี่ยวกับ art beach club</li>
				</ul><!-- /.breadcrumb -->
			...
			<div class="page-content">
				...
				<div class="row">
					<?php $font = ( "SELECT * FROM fontweb where type='art_beach_club1' " );
					...
					<form action="save_fontweb.php"  method="post">
						<div class="col-xs-12">
							<div class="col-sm-12">
								<h4 class="header black">ข้อความเกี่ยวกับ art beach club ภาษาไทย</h4>
								<textarea name="detail_th" id="detail" rows="10"  cols="90%"><?php echo $ro['detail_th'];?></textarea>
								<input value="art_beach_club1" name="type" hidden=""><br><br>
							</div>
						</div>

						<div class="col-xs-12">
							<div class="col-sm-12">
								<h4 class="header black">ข้อความเกี่ยวกับ art beach club ภาษาอังกฤษ</h4>
								<textarea name="detail_en" id="detail1" rows="10"  cols="90%"><?php echo $ro['detail_en'];?></textarea>
								<!-- <input value="art_beach_club2" name="type" hidden=""><br><br> -->
							</div>
						</div>

						<div class="col-xs-12">
							<div class="col-sm-12">
								<h4 class="header black">ข้อความเกี่ยวกับ art beach club ภาษาจีน</h4>
						...
						<!-- <div class="col-xs-6">
						<?php $font = ( "SELECT * FROM fontweb where type='img_art_beach_club' " );
						$re = mysqli_query( $con, $font );
						$ro = mysqli_fetch_assoc($re);
						?>
						...
						<div class="col-sm-3"></div>					
							<div class="col-sm-5" align="center">
								<h4 class="header black">จัดการรูปภาพ art beach club 1</h4>
								...
								<input value="img_art_beach_club1" name="type" hidden=""><br><br>
