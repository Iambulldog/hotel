...
<!-- 							<div class="col-xs-6">
 ...
 -->
						<div class="col-xs-6">
						<?php $font = ( "SELECT * FROM fontweb where type='img_location' " );
						$re = mysqli_query( $con, $font );
						$ro = mysqli_fetch_assoc($re);
						?>
												<form action="save_fontweb.php"  enctype="multipart/form-data" method="post">	
