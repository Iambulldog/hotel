		...
		<div class="main-content-inner">
			<div class="breadcrumbs ace-save-state" id="breadcrumbs">
				<ul class="breadcrumb">
					...
					<li class="active">แก้ไขข้อความเกี่ยวกับ Thai cookery class</li>
				</ul><!-- /.breadcrumb -->
			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xs-6">
						<!-- PAGE CONTENT BEGINS -->
						<!-- ข้อมูล-->
						<?php $font = ( "SELECT * FROM fontweb where type='Thai_cookery_class1' " );
						$re = mysqli_query( $con, $font);
						$ro = mysqli_fetch_assoc($re);
						?>
						<form action="save_fontweb.php"  method="post">						
							<div class="col-sm-12">
								<h4 class="header black">ข้อความเกี่ยวกับ Thai cookery class 1</h4>
								<textarea name="detail_th" id="detail" rows="10"  cols="90%"><?php echo $ro['detail_th'];?></textarea>
								<input value="Thai_cookery_class1" name="type" hidden=""><br><br>
							</div>
							<center>
						...
						<!-- PAGE CONTENT BEGINS -->
						<!-- ข้อมูล-->
						<?php $font = ( "SELECT * FROM fontweb where type='Thai_cookery_class2' " );
						$re = mysqli_query( $con, $font);
						$ro = mysqli_fetch_assoc($re);
						?>
						<form action="save_fontweb.php"  method="post">						
							<div class="col-sm-12">
								<h4 class="header black">ข้อความเกี่ยวกับ Thai cookery class 2</h4>
								<textarea name="detail_en" id="detail1" rows="10"  cols="90%"><?php echo $ro['detail_th'];?></textarea>
								<input value="Thai_cookery_class2" name="type" hidden=""><br><br>
							</div>
							<center>
								<button type="submit" class="btn btn-danger">แก้ไข</button>
								<a href="index.php" type="submit" class="btn btn-success">กลับหน้าเเรก</a></center><br><br>
						...
						<div class="col-xs-6">
						<?php $font = ( "SELECT * FROM fontweb where type='img_Thai_cookery_class' " );
						$re = mysqli_query( $con, $font );
						$ro = mysqli_fetch_assoc($re);
						?>
						...
						<div class="col-sm-3"></div>					
							<div class="col-sm-5" align="center">
								<h4 class="header black">จัดการรูปภาพ Thai cookery class  1</h4>
								...
								<input value="img_Thai_cookery_class1" name="type" hidden=""><br><br>
