		...
		<div class="main-content-inner">
			<div class="breadcrumbs ace-save-state" id="breadcrumbs">
				<ul class="breadcrumb">
					...
					<li class="active">แก้ไขข้อความเกี่ยวกับ steak house</li>
				</ul><!-- /.breadcrumb -->
			...
			<div class="page-content">
				<?php $font = ( "SELECT * FROM fontweb where type='private_candle_light1' " );
				...
				<div class="row">
					<form action="save_fontweb.php"  method="post">	
						...
						<div class="col-xs-6">
							<div class="col-sm-12">
								<h4 class="header black">ข้อความเกี่ยวกับ private candle light ภาษาไทย</h4>
						...
						<div class="col-xs-6">
							<div class="col-sm-12">
								<h4 class="header black">ข้อความเกี่ยวกับ private candle light ภาษาอังกฤษ</h4>
						...
						<div class="col-xs-6">
							<div class="col-sm-12">
								<h4 class="header black">ข้อความเกี่ยวกับ private candle light ภาษาจีน</h4>
								<textarea name="detail_cn" id="detail2" rows="10"  cols="90%"><?php echo $ro['detail_cn'];?></textarea>
								<input value="private_candle_light1" name="type" hidden=""><br><br>
							</div>
							<center>
...
<!-- 							<div class="col-xs-6">
						...
						<?php $font = ( "SELECT * FROM fontweb where type='shine_bar2' " );
						$re = mysqli_query( $con, $font);
						$ro = mysqli_fetch_assoc($re);
						?>
						<form action="save_fontweb.php"  method="post">						
							<div class="col-sm-12">
								<h4 class="header black">ข้อความเกี่ยวกับ shine bar 2</h4>
								<textarea name="detail_en" id="detail1" rows="10"  cols="90%"><?php echo $ro['detail_th'];?></textarea>
								<input value="shine_bar2" name="type" hidden=""><br><br>
							</div>
							<center>
								<button type="submit" class="btn btn-danger">แก้ไข</button>
						...
						<div class="col-xs-6">
						<?php $font = ( "SELECT * FROM fontweb where type='img_shine_bar' " );
						$re = mysqli_query( $con, $font );
						$ro = mysqli_fetch_assoc($re);
						?>
						...
						<div class="col-sm-3"></div>					
							<div class="col-sm-5" align="center">
								<h4 class="header black">จัดการรูปภาพ shine bar 1</h4>
								...
								<input value="img_shine_bar1" name="type" hidden=""><br><br>
 ...
 -->
						<div class="col-xs-6">
						<?php $font = ( "SELECT * FROM fontweb where type='img_private_candle_light' " );
						$re = mysqli_query( $con, $font );
						$ro = mysqli_fetch_assoc($re);
						?>
												<form action="save_fontweb.php"  enctype="multipart/form-data" method="post">	
