	...
	<div class="main-content">
		<div class="main-content-inner">
			...
			<div class="page-content">
				<?php $font = ( "SELECT * FROM fontweb where type='wedding_styles1' " );
				...
				<div class="row">
					<form action="save_fontweb.php"  method="post">				
						<div class="col-xs-6">
							<div class="col-sm-12">
								<h4 class="header black">ข้อความเกี่ยวกับ wedding styles ภาษาไทย</h4>
						...
						<div class="col-xs-6">
							<div class="col-sm-12">
								<h4 class="header black">ข้อความเกี่ยวกับ wedding styles ภาษาอังกฤษ</h4>
						...
						<div class="col-xs-6">
							<div class="col-sm-12">
								<h4 class="header black">ข้อความเกี่ยวกับ wedding styles ภาษาจีน</h4>
								<textarea name="detail_cn" id="detail2" rows="10"  cols="90%"><?php echo $ro['detail_cn'];?></textarea>
								<input value="wedding_styles1" name="type" hidden=""><br><br>
							</div>
							<center>
...
<!-- 							<div class="col-xs-6">
 ...
 -->
						<div class="col-xs-6">
						<?php $font = ( "SELECT * FROM fontweb where type='img_wedding_styles' " );
						$re = mysqli_query( $con, $font );
						$ro = mysqli_fetch_assoc($re);
						?>
												<form action="save_fontweb.php"  enctype="multipart/form-data" method="post">	
