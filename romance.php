        ...
        <div class="container">
            ...
            <div class="header_right float-right">
                <div class="dropdown language">
                    ...
                    <ul id="ch_lang">
                        <li id="liEN" ><a href="romance.php?lang=en"><img src="img/icon_en.png" height="25" width="25">    ENG</a></li>
                        <li id="liTH" ><a href="romance.php?lang=th"><img src="img/icon_th.png" height="25" width="25">    TH</a></li>
                        <li id="liTH" ><a href="romance.php?lang=cn"><img src="img/icon_cn.png" height="25" width="25">    CN</a></li>
                    </ul>
                </div>
            </div>
        ...
        <section class="section-slider">
            ...
            <div id="slider-revolution">
                <ul>
                     ...
                     <?php $sql = ( "SELECT * FROM bg where status=1 AND type = 4" );
...
<section class="content-container"style="background-color: #FFFFFF;opacity:0.92;filter:alpha(opacity=92);padding-top: 20px">
    <div class="container">
        <div class="row">
            <div class='col-sm-12'><h2 class='text-center'>Romance</h2></div>
                <div class='clearfix'></div>
                <!-- Start Item -->
                ...
                <div class="col-sm-12 col-lg-7" style="padding:15px;">
                    <div class="row">
                        <div >
                            ...
                            <h3 class="text16">Wedding Styles</h3>
                            <p></p>
                             <a href="romance_detail.php?ID_room=img_wedding_styles&type=wedding_styles1" class="btn btn-info" role="button">Details</a>
                           </div>
                        <div class="clearfix"></div>
                        </div>
                    </div>
        ...
        <div class="col-sm-6" style="margin-bottom:30px;">
            <div class="col-sm-12 col-lg-5">
                <div class="row">
                    <div class="shadow" style="padding:5px;">
                    <img src="img/20171210153706.jpg" alt="Making Merit in Thai Way." title="Making Merit in Thai Way." style="width:100%;">
                    <div class="clearfix"></div>
                    </div>
                </div>
            </div>
        <div class="col-sm-12 col-lg-7" style="padding:15px;">
            <div class="row">
                <div >
                    <div class="col-sm-12" style="padding-bottom:15px;">
                    <h3 class="text16">private candle light</h3>
                    <p></p>
                    <a href="romance_detail.php?ID_room=img_private_candle_light&type=private_candle_light1" class="btn btn-info" role="button"> Details </a>
                    </div>
                    <div class="clearfix"></div>
                </div>
            </div>
