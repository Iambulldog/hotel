...
<section style="padding-top: 150px">
  ...
  <div class="col-sm-12 col-lg-12 overlay-container" style="padding:15px;">
    <div class="container">
      <?php $font2 = ( "SELECT * FROM fontweb where type='Merit_making_to_the_monks1' " );
  ...
  <div id="slide" class="slide">
    <ul class="slide_list">
     <?php 
     $sqlnum = "SELECT * FROM img_room where status=1 AND  ID_room = '2006' ";
     $sqlqu = mysqli_query( $con, $sqlnum );     
     $num = mysqli_num_rows($sqlqu);
     $sql = ( "SELECT * FROM img_room where status=1 AND ID_room = '2006' " );
...
<!-- <section style="padding-top: 150px">
  <div class="col-sm-12 overlay-container">
    <div class="col-sm-6"> 
     <?php $font33 = ( "SELECT * FROM fontweb where type='img_Merit_making_to_the_monks' " );
...
<div class="col-sm-12 overlay-container">
  <div class="col-sm-6">
    <div class="col-sm-12" style="padding-bottom:15px;">
          <?php $font22 = ( "SELECT * FROM fontweb where type='Merit_making_to_the_monks2' " );
 ...
 <div class="col-sm-6"> 
       <?php $font333 = ( "SELECT * FROM fontweb where type='img_Merit_making_to_the_monks' " );
