...
<div class="col-sm-12 col-lg-12" style="padding:15px;">
            <div class="container">
                     ...
                     <?php $font2 = ( "SELECT * FROM fontweb where type='sukoi_teppanyaki1' " );
...
<div id="slide" class="slide">
  <ul class="slide_list">
     <?php   
                $sqlnum = "SELECT * FROM img_room where status=1 AND  ID_room = '1003' ";
                $sqlqu = mysqli_query( $con, $sqlnum );     
                $num = mysqli_num_rows($sqlqu);
                $sql = ( "SELECT * FROM img_room where status=1 AND ID_room = '1003' " );
...
<div class="col-sm-12 overlay-container">
    <div class="col-sm-6"> 
   <?php $font33 = ( "SELECT * FROM fontweb where type='img_sukoi_teppanyaki' " );
          $re33 = mysqli_query( $con, $font33 );
          $ro33 = mysqli_fetch_assoc( $re33 );?>
                      
                    <img src="img/<?php echo $ro33['detail_th'];?>" width="100%" height="550" alt="" title="" >
    </div>
    <div class="col-sm-6">
     <?php $font2 = ( "SELECT * FROM fontweb where type='sukoi_teppanyaki1' " );
          $re2 = mysqli_query( $con, $font2 );
...
<div class="col-sm-12 overlay-container">
    ...
    <div class="col-sm-6">
       <?php $font22 = ( "SELECT * FROM fontweb where type='sukoi_teppanyaki2' " );
          $re22 = mysqli_query( $con, $font22 );
          $ro22 = mysqli_fetch_assoc( $re22 );?>
                    <h1 ><?php echo $ro22['detail_en'];?></h1><br>     
    </div>
 <div class="col-sm-6"> 
         <?php $font333 = ( "SELECT * FROM fontweb where type='img_sukoi_teppanyaki' " );
          $re333 = mysqli_query( $con, $font333 );
          $ro333 = mysqli_fetch_assoc( $re333 );?>
                    <img src="img/<?php echo $ro333['detail_en'];?>" width="100%" height="550" alt="" title="" ">
 </div>
