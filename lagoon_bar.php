...
<div class="col-sm-12 col-lg-12 overlay-container" style="padding:15px;">
           <div class="container">
                     <?php $font2 = ( "SELECT * FROM fontweb where type='lagoon_bar1' " );
...
<div id="slide" class="slide">
  <ul class="slide_list">
     <?php   
                $sqlnum = "SELECT * FROM img_room where status=1 AND  ID_room = '1004' ";
                $sqlqu = mysqli_query( $con, $sqlnum );     
                $num = mysqli_num_rows($sqlqu);
                $sql = ( "SELECT * FROM img_room where status=1 AND ID_room = '1004' " );
...
<div class="col-sm-12 overlay-container">
    <div class="col-sm-6"> 
   <?php $font33 = ( "SELECT * FROM fontweb where type='img_lagoon_bar' " );
...
<div class="col-sm-12 overlay-container">
    ...
    <div class="col-sm-6">
      <?php $font22 = ( "SELECT * FROM fontweb where type='lagoon_bar2' " );
          $re22 = mysqli_query( $con, $font22 );
          $ro22 = mysqli_fetch_assoc( $re22 );?>
                    <h1 ><?php echo $ro22['detail_en'];?></h1><br>    
    </div>
 <div class="col-sm-6"> 
        <?php $font333 = ( "SELECT * FROM fontweb where type='img_lagoon_bar' " );
