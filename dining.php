        ...
        <div class="container">
            ...
            <div class="header_right float-right">
                <div class="dropdown language">
                    ...
                    <ul id="ch_lang">
                        <li id="liEN" ><a href="dining.php?lang=en"><img src="img/icon_en.png" height="25" width="25">    ENG</a></li>
                        <li id="liTH" ><a href="dining.php?lang=th"><img src="img/icon_th.png" height="25" width="25">    TH</a></li>
                        <li id="liTH" ><a href="dining.php?lang=cn"><img src="img/icon_cn.png" height="25" width="25">    CN</a></li>
                    </ul>
                </div>
            </div>
        ...
        <section class="section-slider">
            ...
            <div id="slider-revolution">
                <ul>
                     ...
                     <?php $sql = ( "SELECT * FROM bg where status=1 AND type = 3" );
...
<section class="content-container"style="background-color: #FFFFFF;opacity:0.92;filter:alpha(opacity=92);padding-top: 20px">
    ...
    <div class="container">
        <div class="row">
            <div class='col-sm-12'><h2 class='text-center'>Dining</h2></div>
                <div class='clearfix'></div>
                <!-- Start Item -->
                ...
                <div class="col-sm-12 col-lg-5">
                    <div class="row">
                        <div class="shadow" style="padding:5px;">
                            <img src="img/Artbeach001.jpg" alt="WEDDING & EVENTS"  style="width:100%;">
                            <div class="clearfix"></div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-12 col-lg-7" style="padding:15px;">
                    <div class="row">
                        <div >
                            ...
                            <h3 class="text16">art beach club</h3>
                            <p></p>
                             <a href="dining_detail.php?ID_room=1000&type=art_beach_club1" class="btn btn-info" role="button">Details</a>
                            </div>
                        <div class="clearfix"></div>
                        </div>
                    </div>
        ...
        <div class="col-sm-4" style="margin-bottom:30px;">
            <div class="col-sm-12 col-lg-5">
                <div class="row">
                    <div class="shadow" style="padding:5px;">
                    <img src="img/imgroom/DSC_1960.jpg" alt="Making Merit in Thai Way."  style="width:100%;">
                    <div class="clearfix"></div>
                    </div>
                </div>
            </div>
        <div class="col-sm-12 col-lg-7" style="padding:15px;">
            <div class="row">
                <div >
                    <div class="col-sm-12" style="padding-bottom:15px;">
                    <h3 class="text16">Pattaya Restaurents</h3>
                    <p></p>
                    <a href="dining_detail.php?ID_room=1001&type=pattaya_restaurents" class="btn btn-info" role="button"> Details </a>
                    </div>
                    <div class="clearfix"></div>
                </div>
            </div>
        ...
        <div class="col-sm-4" style="margin-bottom:30px;">
            <div class="col-sm-12 col-lg-5">
                <div class="row">
                    <div class="shadow" style="padding:5px;">
                    <img src="img/imgroom/steak_house1.jpg"  style="width:100%;">
                    <div class="clearfix"></div>
                    </div>
                </div>
            </div>
        <div class="col-sm-12 col-lg-7" style="padding:15px;">
            <div class="row">
                <div >
                    <div class="col-sm-12" style="padding-bottom:15px;">
                    <h3 class="text16">STEAK HOUSE</h3>
                    <p></p>
                    <a href="dining_detail.php?ID_room=1002&type=steak_house1" class="btn btn-info" role="button"> Details </a>
                    </div>
                    <div class="clearfix"></div>
                </div>
            </div>
        ...
        <div class="col-sm-4" style="margin-bottom:30px;">
            <div class="col-sm-12 col-lg-5">
                <div class="row">
                    <div class="shadow" style="padding:5px;">
                    <img src="img/imgroom/IMG_4458.jpg"   style="width:100%;">
                    <div class="clearfix"></div>
                    </div>
                </div>
            </div>
        <div class="col-sm-12 col-lg-7" style="padding:15px;">
            <div class="row">
                <div >
                    <div class="col-sm-12" style="padding-bottom:15px;">
                    <h3 class="text16">Sugoi Teppanyagi Lipe.</h3>
                    <p></p>
                    <a href="dining_detail.php?ID_room=1003&type=sukoi_teppanyaki1" class="btn btn-info" role="button"> Details </a>
                    </div>
                    <div class="clearfix"></div>
                </div>
            </div>
        ...
        <div class="col-sm-4" style="margin-bottom:30px;">
            <div class="col-sm-12 col-lg-5">
                <div class="row">
                    <div class="shadow" style="padding:5px;">
                    <img src="img/imgroom/shine_bar1.jpg"   style="width:100%;">
                    <div class="clearfix"></div>
                    </div>
                </div>
            </div>
        <div class="col-sm-12 col-lg-7" style="padding:15px;">
            <div class="row">
                <div >
                    <div class="col-sm-12" style="padding-bottom:15px;">
                    <h3 class="text16">SHINE BAR</h3>
                    <p></p>
                    <a href="dining_detail.php?ID_room=1006&type=shine_bar1" class="btn btn-info" role="button"> Details </a>
                    </div>
                    <div class="clearfix"></div>
                </div>
            </div>
