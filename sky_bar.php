...
<div class="col-sm-12 col-lg-12 overlay-container" style="padding:15px;">
           <div class="container">
                     <?php $font2 = ( "SELECT * FROM fontweb where type='sky_bar1' " );
...
<div class="col-sm-12 overlay-container">
    <div class="col-sm-6"> 
     <?php $font33 = ( "SELECT * FROM fontweb where type='img_sky_bar' " );
...
<div class="col-sm-12 overlay-container">
    ...
    <div class="col-sm-6">
      <?php $font22 = ( "SELECT * FROM fontweb where type='sky_bar2' " );
 ...
 <div class="col-sm-6"> 
       <?php $font333 = ( "SELECT * FROM fontweb where type='img_sky_bar' " );
