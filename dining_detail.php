        ...
        <div class="container">
            ...
            <div class="header_right float-right">
                <div class="dropdown language">
                    ...
                    <ul id="ch_lang">
                        <li id="liEN" ><a href="dining_detail.php?ID_room=<?php echo $room ;?>&type=<?php echo $type ;?>&lang=en"><img src="img/icon_en.png" height="25" width="25">    ENG</a></li>
                        <li id="liTH" ><a href="dining_detail.php?ID_room=<?php echo $room ;?>&type=<?php echo $type ;?>&lang=th"><img src="img/icon_th.png" height="25" width="25">    TH</a></li>
                        <li id="liTH" ><a href="dining_detail.php?ID_room=<?php echo $room ;?>&type=<?php echo $type ;?>&lang=cn"><img src="img/icon_cn.png" height="25" width="25">    CN</a></li>
                    </ul>
                </div>
            </div>
        </div>
