...
<div class="col-sm-12 col-lg-12" style="padding:15px;">
            <div class="container">
                     ...
                     <?php $font2 = ( "SELECT * FROM fontweb where type='shine_bar1' " );
...
<div id="slide" class="slide">
  <ul class="slide_list">
     <?php   
                $sqlnum = "SELECT * FROM img_room where status=1 AND  ID_room = '1006' ";
                $sqlqu = mysqli_query( $con, $sqlnum );     
                $num = mysqli_num_rows($sqlqu);
                $sql = ( "SELECT * FROM img_room where status=1 AND ID_room = '1006' " );
...
<div class="col-sm-12 overlay-container">
    <div class="col-sm-6"> 
     <?php $font33 = ( "SELECT * FROM fontweb where type='img_shine_bar' " );
          $re33 = mysqli_query( $con, $font33 );
          $ro33 = mysqli_fetch_assoc( $re33 );?>
                      
            <img src="img/<?php echo $ro33['detail_en'];?>" width="650" height="550" alt="" title="" >
    </div>
    <div class="col-sm-6">
       <?php $font2 = ( "SELECT * FROM fontweb where type='shine_bar1' " );
          $re2 = mysqli_query( $con, $font2 );
...
<div class="col-sm-12 overlay-container">
    ...
    <div class="col-sm-6">
       ...
       <?php $font22 = ( "SELECT * FROM fontweb where type='shine_bar2' " );
 ...
 <div class="col-sm-6"> 
         <?php $font333 = ( "SELECT * FROM fontweb where type='img_shine_bar' " );
