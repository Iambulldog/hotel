            ...
            <div class="sub-banner">
                <div class="container">
                    <div class="text text-center">
                        <h2 style="font-family: 'Prompt', sans-serif; !important">travel</h2>
                        <p>Ananya Lipe</p>
                    </div>
                </div>
            </div>
...
<div class="col-sm-12 overlay-container">
    <div class="col-sm-6"> 
    <img src="img/20170612150437.jpg" title="All-Inclusive Holidays for less" alt="All-Inclusive Holidays for less" class="img-responsive">
    </div>
    <div class="col-sm-6">
      <?php $font2 = ( "SELECT * FROM fontweb where type='lifestyle' " );
      $re2 = mysqli_query( $con, $font2 );
      $ro2 = mysqli_fetch_assoc( $re2 );?>
           <span><?php echo $ro2[$fde];?></span>
...
<div class="col-sm-12 overlay-container">
    ...
    <div class="col-sm-6">
      <?php $font2 = ( "SELECT * FROM fontweb where type='plane' " );
      $re2 = mysqli_query( $con, $font2 );
      $ro2 = mysqli_fetch_assoc( $re2 );?>
           <span><?php echo $ro2[$fde];?></span>          
    </div>
 <div class="col-sm-6"> 
        <img src="img/20170612144519.jpg" title="All-Inclusive Holidays for less" alt="All-Inclusive Holidays for less" class="img-responsive">
 </div>
