        ...
        <div class="container">
            ...
            <div class="header_right float-right">
                <div class="dropdown language">
                    ...
                    <ul id="ch_lang">
                        <li id="liEN" ><a href="activities.php?lang=en"><img src="img/icon_en.png" height="25" width="25">    ENG</a></li>
                        <li id="liTH" ><a href="activities.php?lang=th"><img src="img/icon_th.png" height="25" width="25">    TH</a></li>
                        <li id="liTH" ><a href="activities.php?lang=cn"><img src="img/icon_cn.png" height="25" width="25">    CN</a></li>
                    </ul>
                </div>
            </div>
        ...
        <section class="section-slider">
            ...
            <div id="slider-revolution">
                <ul>
                     ...
                     <?php $sql = ( "SELECT * FROM bg where status=1 AND type = 5" );
...
<section class="content-container"style="background-color: #FFFFFF;opacity:0.92;filter:alpha(opacity=92);padding-top: 20px">
        ...
        <div class="container">
        <div class="row">
            <div class='col-sm-12'><h2 class='text-center'>Activities</h2></div>
                <div class='clearfix'></div>
                <!-- Start Item -->
                ...
                <div class="col-sm-12 col-lg-5">
                    ...
                    <img src="img/imgroom/excursion2.jpg"  style="width:100%;height: 120px">
                            <div class="clearfix"></div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-12 col-lg-7" style="padding:15px;">
                    <div class="row">
                        <div >
                            ...
                            <h3 class="text16">excursions</h3>
                            <p></p>
                             <a href="activities_detail.php?ID_room=2000&type=excursions1" class="btn btn-info" role="button">Details</a>
                            </div>
                        <div class="clearfix"></div>
                        </div>
                    </div>
        ...
        <div class="col-sm-4" style="margin-bottom:30px;">
            <div class="col-sm-12 col-lg-5">
                <div class="row">
                    <div class="shadow" style="padding:5px;">
                    <img src="img/imgroom/20180517222247.jpg"   style="width:100%;height: 120px">
                    <div class="clearfix"></div>
                    </div>
                </div>
            </div>
        <div class="col-sm-12 col-lg-7" style="padding:15px;">
            <div class="row">
                <div >
                    <div class="col-sm-12" style="padding-bottom:15px;">
                    <h3 class="text16">fitness center</h3>
                    <p></p>
                    <a href="activities_detail.php?ID_room=2001&type=fitness_center1" class="btn btn-info" role="button"> Details </a>
                    </div>
                    <div class="clearfix"></div>
                </div>
            </div>
        ...
        <div class="col-sm-12 col-lg-7" style="padding:15px;">
            <div class="row">
                <div >
                    <div class="col-sm-12" style="padding-bottom:15px;">
                    <h3 class="text16">thai massage</h3>
                    <p></p>
                    <a href="activities_detail.php?ID_room=2002&type=thai_massage" class="btn btn-info" role="button"> Details </a>
                    </div>
                    <div class="clearfix"></div>
                </div>
            </div>
        ...
        <div class="col-sm-12 col-lg-7" style="padding:15px;">
            <div class="row">
                <div >
                    <div class="col-sm-12" style="padding-bottom:15px;">
                    <h3 class="text16">kid club</h3>
                    <p></p>
                    <a href="activities_detail.php?ID_room=2003&type=kid_club" class="btn btn-info" role="button"> Details </a>
                    </div>
                    <div class="clearfix"></div>
                </div>
            </div>
       ...
       <!--  <div class="col-sm-4" style="margin-bottom:30px;">
        ...
        <div class="col-sm-12 col-lg-7" style="padding:15px;">
            <div class="row">
                <div >
                    <div class="col-sm-12" style="padding-bottom:15px;">
                    <h3 class="text16">beach activity center</h3>
                    <p></p>
                    <a href="activities_detail.php?ID_room=2004&type=beach_activity_center" class="btn btn-info" role="button"> Details </a>
                    </div>
                    <div class="clearfix"></div>
                </div>
            </div>
        ...
        <div class="clearfix"></div>
         ...
         <div class="col-sm-4" style="margin-bottom:30px;">
            <div class="col-sm-12 col-lg-5">
                <div class="row">
                    <div class="shadow" style="padding:5px;">
                    <img src="img/555.jpg"   style="width:100%;height: 120px">
                    <div class="clearfix"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div >
                    ...
                    <p></p>
                    <a href="activities_detail.php?ID_room=2005&type=yoga" class="btn btn-info" role="button"> Details </a>
                    </div>
                    <div class="clearfix"></div>
                </div>
            </div>
        ...
        <div class="clearfix"></div>
         ...
         <div class="col-sm-4" style="margin-bottom:30px;">
            <div class="col-sm-12 col-lg-5">
                <div class="row">
                    <div class="shadow" style="padding:5px;">
                    <img src="img/212.jpg"   style="width:100%;height: 120px">
                    <div class="clearfix"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div >
                    <div class="col-sm-12" style="padding-bottom:15px;">
                    <h3 class="text16">Merit making to the monks</h3>
                    <p></p>
                    <a href="activities_detail.php?ID_room=2006&type=Merit_making_to_the_monks" class="btn btn-info" role="button"> Details </a>
                    </div>
                    <div class="clearfix"></div>
                </div>
            </div>
        ...
        <div class="clearfix"></div>
         ...
         <div class="col-sm-4" style="margin-bottom:30px;">
            <div class="col-sm-12 col-lg-5">
                <div class="row">
                    <div class="shadow" style="padding:5px;">
                    <img src="img/imgroom/IMG_3241.JPG"   style="width:100%;height: 120px">
                    <div class="clearfix"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div >
                    <div class="col-sm-12" style="padding-bottom:15px;">
                    <h3 class="text16">Thai cookery class</h3>
                    <p></p>
                    <a href="activities_detail.php?ID_room=2007&type=Thai_cookery_class" class="btn btn-info" role="button"> Details </a>
                    </div>
                    <div class="clearfix"></div>
                </div>
            </div>
