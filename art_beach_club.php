...
<div class="col-sm-12 col-lg-12 overlay-container" style="padding:15px;">
                     ...
                     <?php $font2 = ( "SELECT * FROM fontweb where type='art_beach_club1' " );
...
<div id="slide" class="slide">
  <ul class="slide_list">
     <?php   
                $sqlnum = "SELECT * FROM img_room where status=1 AND  ID_room = '1000' ";
                $sqlqu = mysqli_query( $con, $sqlnum );     
                $num = mysqli_num_rows($sqlqu);
                $sql = ( "SELECT * FROM img_room where status=1 AND ID_room = '1000' " );
...
<!--              <section class="content-container" style="padding-top: 150px">
            ...
            <div class="col-sm-12 col-lg-6">
                <div class="row">
                    <div class="shadow" >
          <?php $font33 = ( "SELECT * FROM fontweb where type='img_art_beach_club' " );
        ...
        <div class="col-sm-12" style="margin-bottom:30px;">
            <div class="col-sm-12 col-lg-6">
                <div class="row">
                   <div class="shadow" style="border:1px solid #f5f5f5;">
                    <div class="col-sm-12" style="padding-bottom:15px;">
          <?php $font22 = ( "SELECT * FROM fontweb where type='art_beach_club2' " );
        ...
        <div class="col-sm-12 col-lg-6" >
            <div class="row">
                <div class="shadow" >
          <?php $font333 = ( "SELECT * FROM fontweb where type='img_art_beach_club' " );
